...
手部復健偵測系統 - v19 UI 優化版
變更點:
1. 將 CV Group (幾何分類) 與 System State (系統狀態) 的文字顯示，
   從主畫面移至「Debug: ROI Mask」視窗的左上角。
2. 為了確保文字清晰，將 Mask 視窗統一放大至 300x300 顯示。
"""
